	...
	Employee()
	{
		try
		{
			...
			while(true)
			{
				...
				{
					System.out.print("Please enter number only number format: ");
					System.out.print("Enter age: ");
					age = sc.nextInt();
				}*/
				...
				{
					//System.out.println("value check:"+age);
...
int num=0;
int func=0;
Employee []emp_c=new Employee[10];
do{
	...
	switch(num)
   {
    ...
    System.out.println("__CLERK Entry__");
     num=0;//exception check
      emp_c[Employee.count]=new Clerk();
      Employee.count++;
	  break;
    case 2:
    System.out.println("__PROGRAMMER Entry__");
    emp_c[Employee.count]=new Programmer();
    num=0;//exception check
	Employee.count++;
	break;
    case 3:
    ...
    emp_c[Employee.count]=new Manager();
    Employee.count++;
    break;
